...
import com.vinny.ttdapp.TtdRegistrationFragment;

public class TtdTempleTask extends AsyncTask<String, Integer, String>{
	
	private ProgressDialog progDialog;
	private Context context;
	private TtdRegistrationFragment activity;
	private String type;
	
	
	private static final String debugTag = "TtdDistrictTask";
	
	public TtdTempleTask(TtdRegistrationFragment activity,String type){
		super();
