...
public class TtdTempleEditDeleteTask extends AsyncTask<String, Integer, String>{
	
	private ProgressDialog progDialog;
	private Context context;
	private TtdTempleEditDeleteFragment activity;
	private String type;
	
	
	private static final String debugTag = "TtdDistrictTask";
	
	public TtdTempleEditDeleteTask(TtdTempleEditDeleteFragment activity,String type){
		super();
