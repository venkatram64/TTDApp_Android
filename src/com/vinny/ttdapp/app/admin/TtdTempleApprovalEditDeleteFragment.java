...
import com.vinny.ttdapp.admin.util.TtdTempleApprovalEditDeleteTask;
...
public class TtdTempleApprovalEditDeleteFragment extends Fragment implements OnItemSelectedListener,OnClickListener{
...
Context context;
	...
	Button ttdEdit,ttdDelete,ttdApprove;
	...
	public void onAttach(Activity activity) {
		...
		try {
			...
			Log.d("TtdEditDeleteTemplateHandler : " , getActivity().getClass().getSimpleName() + 
					" not implementd " + TtdTempleApprovalEditDeleteFragment.class.getSimpleName());
		}
	}
	...
	public void onResume() {
		...
		if(this.districtDataList == null){
			TtdTempleApprovalEditDeleteTask dtask = new TtdTempleApprovalEditDeleteTask(TtdTempleApprovalEditDeleteFragment.this, TtdTypeEnum.DISTRICT.toString());
			try{
				dtask.execute("all");
			}catch (Exception e)
	        {
	...
	public void onClick(View view) {
		...
		case R.id.ttd_rapproval:
			...
			info1.setType(TtdTypeEnum.APPROVE.toString());
			ttdEditDeleteTemplateHandler.onTtdApproveTemplateHandler(info1);
			return;
		case R.id.ttd_redit:
			info1.setId(selectedTempId);
			info1.setCatName(catName);
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,long id) {
		...
		if(R.id.ttd_rdistrictId == parent.getId()){
			...
			TtdTempleApprovalEditDeleteTask dtask = new TtdTempleApprovalEditDeleteTask(TtdTempleApprovalEditDeleteFragment.this, TtdTypeEnum.MANDAL.toString());
			try{
		...
		if(R.id.ttd_rmandalId == parent.getId()){
			...
			//Toast.makeText(parent.getContext(), "Selected: " + itemId +"," + itemName, Toast.LENGTH_LONG).show();
			TtdTempleApprovalEditDeleteTask dtask = new TtdTempleApprovalEditDeleteTask(TtdTempleApprovalEditDeleteFragment.this, TtdTypeEnum.VILLAGE.toString());
			try{
		...
		if(R.id.ttd_rvillageId == parent.getId()){
			...
			TtdTempleApprovalEditDeleteTask dtask = new TtdTempleApprovalEditDeleteTask(TtdTempleApprovalEditDeleteFragment.this, TtdTypeEnum.TEMPLE.toString());
			try{
	...
	interface TtdEditDeleteTemplateHandler{
		...
		void onTtdApproveTemplateHandler(TtdTempleInfo info);
	}
