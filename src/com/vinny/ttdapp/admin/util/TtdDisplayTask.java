...
import com.vinny.ttdapp.util.JSONParser;
...
public class TtdDisplayTask extends AsyncTask<String, Integer, String>{
	...
	private TtdTempleApprovalFragment displayFragment;
	...
	public TtdDisplayTask(TtdTempleApprovalFragment displayFragment,List<NameValuePair> params){
		super();
    ...
    try {
        	if(type == TtdTypeEnum.DISPLAY.toString() || type == TtdTypeEnum.SEARCH.toString()
        			...
        			|| type.equals(TtdTypeEnum.APPROVE.toString())){
